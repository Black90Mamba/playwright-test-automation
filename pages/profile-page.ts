...
export class ProfilePage {
  ...
  constructor(page: Page) {
    this.page = page;
    this.loggedInUserMenu = page.locator("//*[@id='navbarSupportedContent']//a[@class='dropdown-toggle']");
    this.profileMenuOption = page.locator("//*[@id='navbarSupportedContent']//a[contains(text(), 'Profil')]");
